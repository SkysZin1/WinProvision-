...
Checked package identifiers against their installer manifests in the official Microsoft repository. Tests cover icon loading, category filters, saved profiles, embedded plans, Store source selection and rejection of an unsigned NVIDIA installer.
