...
public static class AppCatalog
{
 ...
 using var stream=typeof(AppCatalog).Assembly.GetManifestResourceStream("WinProvision.Assets.AdditionalApps.json")??throw new InvalidOperationException(L.T("Missing app catalog."));
