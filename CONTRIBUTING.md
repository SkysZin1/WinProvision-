...
Create a distribution package with `powershell -NoProfile -ExecutionPolicy Bypass -File packaging/Build-Release.ps1`. The script reads the project version, publishes the desktop app, verifies the ZIP contents and writes its SHA-256 checksum. Generated releases, virtual machines, installation media and diagnostic artifacts do not belong in source control.
