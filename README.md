...
- Bilingual app picker at first sign-in: 36 optional apps, search, categories, per-app progress, retry, logs and postponement. Use Applications in the Builder to select and authorize apps before installation, or choose after first boot.
