...
A versão 0.7.0 adiciona Opera GX, Zoom, qBittorrent, Blender, WizTree e Cursor, além de resumo da instalação, opção de tentar novamente apenas as falhas e verificação prévia da internet e do Instalador de Aplicativos.
